...
- 语言：简体中文 / English 双语
- 状态：规格阶段 0–7 完成、阶段 8 基本完成（Windows 出包云机复验通过）、
  阶段 9 大幅推进、阶段 10 基本完成——四轨官制（勋官轨随防秋积转）、五线入仕分化、
  两案闭环 + 铜匦申冤昭雪、考课迁转 + 贬谪/量移、结亲六礼、市集行囊、雇佣佣保、
  遣商队、多结局七档 + 挂冠致仕、Blender 精模坊景 + 像素人实走、
  存档 v4 迁移链与自动存档；引擎内截图 20 张见 `artifacts/unity-shots/`
  与 PR #1（十六轮实机验证）
...
- **四轨官制**：职事官 / 散官 / 勋官 / 爵四条独立轨道；文官线 12 阶、武官线 10 阶、
  宫官线 4 阶（尚宫局，武周段女官起家）迁转序列；文武散官各 29 阶；
  勋官十二转（防秋点兵积转）；唐爵九等。
- **五线入仕**：明镜结案铨选、白身三途（明经/进士行卷/投军）、戍卒叙军功、
  女官应内廷诏、胡商市籍之限（纳资二百贯只得虚衔——身份即命运）。
- **案件**：丝帛血案 + 枯井藏骨按序流转；线索板/组合推论/证人门槛/严刑详审双结局；
  屈打成冤者可诣铜匦申冤昭雪（民望人证具名）。
- **铜匦四匦**（垂拱二年立）：延恩自荐 / 招谏言政 / 申冤雪滞 / 通玄言象，月投一书。
- **经济闭环**：月俸三构成、四档宅邸（乌头门礼制门槛）、市集行囊（《唐六典》
  午开日入前散）、雇佣佣保（月钱随俸结算）、商线遣商队（净利吃江湖名望）。
- **多结局**：紫袍/青云/循吏/江湖/岭南瘴雨/薄宦/布衣七档；冤案永不入循吏传；
  贬谪可量移洗雪；挂冠致仕出生涯回顾卷轴。
...
- **存档**：schema v4 + 版本迁移链（v0→v4）+ 严格校验。关键字段缺失一律响亮失败，
...
```bash
dotnet test core-dotnet/Lingyan.sln    # 252 项契约测试
```
