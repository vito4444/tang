...
namespace Lingyan.Game
{
    ...
    public sealed class GameController : MonoBehaviour
    {
        ...
        private void BuildCameraAndCanvas()
        {
            ...
            // 标签必须是 MainCamera：Camera.main 靠它检索，公告牌朝向依赖（第十轮实机虫）
        ...
        /// <summary>结局卷轴（挂冠致仕触发；存档不销毁）。</summary>
        public void GoEnding()
        {
            _screen = ScreenId.Ending;
            Rebuild();
        }
        ...
        private void Rebuild()
        {
            ...
            switch (_screen)
            {
                ...
                case ScreenId.Ending:
                    EndingScreen.Build(this, _screenRoot);
                    break;
                default:
